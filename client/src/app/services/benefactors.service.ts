...
export class BenefactorsService {
  ...
  getAllBenefactors(
    ...
    return this.http
      ...
      }>(`${BenefactorsService.apiUrl}/all`, body, {
  ...
  public getBenefactor(id: string): Observable<Benefactor> | null {
    return this.http
      .get<Benefactor>(`${BenefactorsService.apiUrl}/${id}`, {
        observe: 'response',
        withCredentials: true,
      })
      .pipe(
  ...
  public updateBenefactor(benefactor: Benefactor): Observable<boolean> | null {
    return this.http
      .put<any>(
        `${BenefactorsService.apiUrl + '/' + benefactor._id}/`,
        benefactor,
  ...
  public deleteBenefactor(id: string): Observable<boolean> | null {
    return this.http
      .delete<any>(`${BenefactorsService.apiUrl}/${id}`, {
        observe: 'response',
        withCredentials: true,
      })
      .pipe(
  ...
  public getAllPickpoints(
    benefactorId: string
  ): Observable<Pickpoint[]> | null {
    return this.http
      .post<Pickpoint[]>(
        `${BenefactorsService.apiUrl}/${benefactorId}/pickpoints/all`,
        {},
        {
          observe: 'response',
          withCredentials: true,
      ...
      .pipe(
        map((response: HttpResponse<any>) => {
          if (response.status === 200) {
            ...
            throw new Error(
              'Error fetching pickpoints for benefactor with id ' +
                benefactorId +
                '.'
            );
          }
  ...
  public getPickpoint(
    ...
    return this.http
      .get<Pickpoint>(
        `${BenefactorsService.apiUrl}/${benefactorId}/pickpoints/${pickpointId}`,
        {
          observe: 'response',
          withCredentials: true,
        }
  ...
  public addPickpoint(
    ...
    return this.http
      .post<any>(
        `${BenefactorsService.apiUrl}/${benefactorId}/pickpoints/`,
        { pickpoint, rest: true },
  ...
  public updatePost(post: Post): Observable<boolean> | null {
    return this.http
      .put<any>(
        `${BenefactorsService.apiUrl}/${post.benefactorId}/posts/${post._id}`,
        post,
        { observe: 'response', withCredentials: true }
      )
      .pipe(
  ...
  public getPosts(benefactorId: string): Observable<Post[]> | null {
    return this.http
      .get<Post[]>(`${BenefactorsService.apiUrl}/${benefactorId}/posts/`, {
        observe: 'response',
        withCredentials: true,
      })
      .pipe(
  ...
  public getLastPosts(
    ...
    return this.http
      .get<Post[]>(
        `${BenefactorsService.apiUrl}/posts/all/${pageSize}/${pageNumber}`,
        { observe: 'response', withCredentials: true }
      )
      .pipe(
        map((response: HttpResponse<any>) => {
  ...
  public getLastOffers(
    ...
    return this.http
      .get<Offer[]>(`${BenefactorsService.apiUrl}/offers/all`, {
        params,
        observe: 'response',
        withCredentials: true,
      })
  ...
  public addOffer(benefactor: string, offer: Offer | null): Observable<any> {
    ...
    return this.http
      .post<any>(`${BenefactorsService.apiUrl}/offers/` + benefactor, offer, {})
      .pipe(
        map((response) => {
          return response;
        })
  ...
  public updateOffer(benefactor: string, offer: Offer): Observable<boolean> {
    return this.http
      .put<any>(`${BenefactorsService.apiUrl}/offers/${benefactor}`, offer, {})
      .pipe(
        map((response) => {
  ...
  public toggleOfferActiveStatus(
    benefactor: string,
    offer: Offer
  ): Observable<boolean> {
  ...
  public getOffers(benefactor: string): Observable<Offer[]> | null {
    return this.http
      .get<Offer[]>(`${BenefactorsService.apiUrl}/offers/` + benefactor)
      .pipe(
        map((response) => {
          return response;
        }),
  ...
  public addPrize(prize: Prize): Observable<any> {
    return this.http
      .post<any>(`${BenefactorsService.apiUrl}/store/`, prize)
      .pipe(
        map((response) => {
          return response;
        })
  ...
  public updatePrize(prize: Prize): Observable<boolean> {
    return this.http
      .put<any>(`${BenefactorsService.apiUrl}/store/` + prize._id, prize)
      .pipe(
        map((response) => {
          if (response.status === 200) {
            return true;
  ...
  public deletePrize(id: string): Observable<boolean> {
    return this.http
      .delete<any>(`${BenefactorsService.apiUrl}/store/` + id)
      .pipe(
        map((response) => {
  ...
  public getPrize(id: string): Observable<any> {
    return this.http
      .get<Prize>(`${BenefactorsService.apiUrl}/store/` + id, {
        observe: 'response',
        withCredentials: true,
      })
      .pipe(
  ...
  public getBenefactorPrizes(id: string): Observable<Prize[]> {
    return this.http
      .get<Prize[]>(`${BenefactorsService.apiUrl}/store/benefactor/` + id, {
        observe: 'response',
        withCredentials: true,
      })
      .pipe(
  ...
  public getAllPrizes(
    ...
    return this.http
      .get<Prize[]>(`${BenefactorsService.apiUrl}/prizes/all`, {
        params,
        observe: 'response',
        withCredentials: true,
      })

...
```
cd existing_repo
git remote add origin https://gitlab.estg.ipp.pt/paw-2324-38/recicla-textil.git
git branch -M master
...
- [ ] [Set up project integrations](https://gitlab.estg.ipp.pt/paw-2324-38/recicla-textil/-/settings/integrations)

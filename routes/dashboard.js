...
router.get('/users', auth.checkAuthenticated, dashboardController.returnUsersDashboard);
// the benefactors data dashboard, this dashboard will be the pillar of the benefactors information processing
router.get('/benefactors', auth.checkAuthenticated, dashboardController.returnBenefactorsDashboard);
